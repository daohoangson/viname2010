...
<div id="mainContent" class="container">
	<h2><?php echo lang('family_name') ?> <?php echo $first->original_family_name ?></h2>
	<div class="column span-18">
		<div class="bordered">
			...
			<ol>
				...
				<?php else: ?>
				<li><a href="<?php echo site_url('/search/more/' . $this->unicoder->base64_encode($first->original_family_name)) ?>" title="<?php echo lang('view_more') ?>">...</a></li>
				<?php endif ?>
				<?php endforeach ?>
			</ol>
		</div>
